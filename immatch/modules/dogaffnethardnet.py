...
class DogAffNetHardNet(FeatureDetection, Matching):
    def __init__(self, args=None):   
        ...
        self.det = cv2.xfeatures2d.SIFT_create(args.npts, contrastThreshold=-10000, edgeThreshold=-10000)
    ...
    def extract_features(self, im):
        ...
        with torch.no_grad():
            ...
            descs = self.desc(patches.view(B * N, CH, H, W)).view(B * N, -1).detach().cpu().numpy()    
